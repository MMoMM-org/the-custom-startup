...
**Note:** This use case saves two aggregates. For atomicity, the driving adapter should wrap it in a transaction — see `reference/cross-cutting-concerns.md` for the transaction pattern. The use case itself is unaware of transactions.
