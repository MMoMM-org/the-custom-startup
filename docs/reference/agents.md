...
The naming convention is `the-[role]/[activity]`. The role provides navigability; the activity defines what the agent actually does. This is intentional — agents specialize in *what they do*, not *who they are*. See [principles.md](../about/principles.md) § 2.4 for why activity specialization beats role mega-agents, and [skill-and-agent-design.md](../about/skill-and-agent-design.md) for the criteria that decide whether a capability lives in an agent, a skill, or inline.
