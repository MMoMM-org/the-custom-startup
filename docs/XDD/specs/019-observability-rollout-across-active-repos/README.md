...
All four are git repositories and all four already have a `.claude/settings.json`, so setup extends
an existing file rather than creating one. No record exists in any of them yet.
