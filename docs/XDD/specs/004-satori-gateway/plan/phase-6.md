...
- [x] **T6.1 Hook manifest (.claude-plugin/hooks/hooks.json)** `[activity: build-platform]`
...
- [x] **T6.2 PostToolUse hook (event capture)** `[activity: build-feature]`
...
- [x] **T6.3 PreCompact hook (snapshot builder)** `[activity: build-feature]`
...
- [x] **T6.4 SessionStart hook (context injection)** `[activity: build-feature]`
...
- [x] **T6.5 UserPromptSubmit and PreToolUse hooks** `[activity: build-feature]`
...
- [x] **T6.6 Phase 6 Validation** `[activity: validate]`
