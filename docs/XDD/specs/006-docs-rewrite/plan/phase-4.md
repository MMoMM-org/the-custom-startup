...
- [ ] **T4.1 Write about/the-custom-philosophy.md** `[activity: documentation]` `[parallel: true]`
...
- [ ] **T4.2 Write about/sources.md** `[activity: documentation]` `[parallel: true]`
...
- [ ] **T4.3 Move about/principles.md** `[activity: documentation]` `[parallel: true]`
