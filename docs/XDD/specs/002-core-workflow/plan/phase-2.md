...
- [x] **T2.1 Rename specify/ → xdd/ and update SKILL.md** `[activity: backend-api]` `[parallel: true]`
...
- [x] **T2.2 Rename specify-requirements/ → xdd-prd/ and update SKILL.md** `[activity: backend-api]` `[parallel: true]`
...
- [x] **T2.3 Rename specify-solution/ → xdd-sdd/ and update SKILL.md** `[activity: backend-api]` `[parallel: true]`
...
- [x] **T2.4 Rename specify-plan/ → xdd-plan/ and update SKILL.md** `[activity: backend-api]` `[parallel: true]`
...
- [x] **T2.5 Rename/update xdd-meta/ SKILL.md for startup.toml resolution** `[activity: backend-api]` `[parallel: true]`
