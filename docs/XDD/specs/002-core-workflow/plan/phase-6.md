...
- [ ] **T6.1 Plugin structure and install validation** `[activity: validate]`
...
- [ ] **T6.2 Skill directory and frontmatter compliance** `[activity: validate]`
...
- [ ] **T6.3 Cross-reference and path compliance** `[activity: validate]`
...
- [ ] **T6.4 Tool compliance — rg/fd/fzf usage** `[activity: validate]`
...
- [ ] **T6.5 End-to-end journey: guide → implement → verify** `[activity: validate]`
...
- [ ] **T6.6 Python venv and test suite final run** `[activity: validate]`
...
- [ ] **T6.7 AGENTS.md and README documentation update** `[activity: validate]`
...
- [ ] **T6.8 Phase 6 Final Validation** `[activity: validate]`
