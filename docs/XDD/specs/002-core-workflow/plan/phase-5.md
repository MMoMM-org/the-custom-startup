...
- [ ] **T5.1 Create receive-review skill** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.2 Create parallel-agents skill** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.3 Enhance brainstorm — spec-review loop at conclusion** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.4 Enhance debug — iron-law anti-shortcut section** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.5 Enhance review — BASE_SHA/HEAD_SHA dispatch** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.6 Enhance analyze — CoD default-on** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.7 Create tcs-helper:git-worktree skill** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.8 Create tcs-helper:finish-branch skill** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.9 Create tcs-helper:docs skill** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.10 Create tcs-team:the-architect/record-decision agent** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T5.11 Phase 5 Validation** `[activity: validate]`
