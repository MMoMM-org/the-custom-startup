...
- [ ] **T1.1 Plugin directory rename (tcs-start → tcs-workflow)** `[activity: backend-api]`
...
- [ ] **T1.2 Create .claude/startup.toml with G/R scope** `[activity: domain-modeling]`
...
- [ ] **T1.3 Create docs/XDD/ directory tree** `[activity: backend-api]`
...
- [ ] **T1.4 One-time spec migration (.start/specs/ → docs/XDD/specs/)** `[activity: backend-api]`
...
- [ ] **T1.5 Fix Python venv in tcs-helper test setup** `[activity: backend-api]`
