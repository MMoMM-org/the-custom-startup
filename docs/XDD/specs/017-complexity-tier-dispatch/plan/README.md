...
|-------|------|--------|-------|------|
| 1 | Tier metadata foundation | COMPLETE | 4 | [phase-1.md](phase-1.md) |
| 2 | Classification in xdd | COMPLETE | 3 | [phase-2.md](phase-2.md) |
...
- [ ] [Phase 1: Tier metadata foundation](phase-1.md)
- [ ] [Phase 2: Classification in xdd](phase-2.md)
