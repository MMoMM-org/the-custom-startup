...
STATUSLINE_URL="https://raw.githubusercontent.com/rsmdt/the-startup/main/scripts/the-custom-startup-statusline-standard.sh"
...
STATUSLINE_PATH="$STATUSLINE_DIR/the-custom-startup-statusline-standard.sh"
